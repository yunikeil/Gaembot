...
bot = discord.Bot(debug_guilds=[1075733298371899433], intents=intents, owner_id=286914074422280194)  # Main file
...
bot.run("MTA3NTcyMzg4MzEzNjY4NDEwMw.GePhqJ.cCZcO4ztwCvJn-Bn3j2QXJjDhCVP7cqwgYHC3o")  # Main file
